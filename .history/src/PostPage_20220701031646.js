      ...
      <article>
        ...
        {!post && 
          <div className="space-y-4">
            ...
            <button className='border bg-blue-500 px-3 py-2 rounded-md text-white active:scale-95 transition transform duration-200'><Link to="/">Visit our Homepage</Link></button>
          </div>
        }
      </article>
    </main>

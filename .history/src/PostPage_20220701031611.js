      ...
      <article>
        ...
        {!post && 
          <div className="space-y-4">
            ...
            <p className='mb-8'>Well that's dissapointing</p>
            <button><Link to="/" className='border bg-blue-500 px-3 py-2 rounded-md text-white active:scale-95 transition transform duration-200'>Visit our Homepage</Link></button>
          </div>
        }
      </article>
    </main>

  ...
  return (
    <form className="flex flex-col bg-black text-white">
      <input 
        ...
        className="flex-1 outline-none text-gray-600 p-2 items-center bg-white border border-black"
      />
      <div className="space-x-6 flex justify-evenly items-center mb-48">

  ...
  return (
    <form className="flex flex-col bg-black text-white">
      ...
      <div className="space-x-6 flex justify-evenly items-center">
        <Link to="/" className="hover:bg-white hover:text-black px-4 py-2">Home</Link>
        <Link to="/post" className="hover:bg-white hover:text-black px-4 py-2">Posts</Link>
        <Link to="about" className="hover:bg-white hover:text-black px-4 py-2">About</Link>
      </div>
    </form>
  )
}
